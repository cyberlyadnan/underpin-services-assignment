...
export const footerData = {
  ...
  headingMarketplace: "Marketplace",
  headingHeadquarters: "Headquarters",
  copyrightText: "Copyright © 2022 Blackrose Club. All rights reserved.",
  logo:"/logo/Logo.svg",
  socialLinks: [
    { icon: FaDiscord, href: "#" },
    { icon: FaTwitter, href: "#" },
...
export const documents = [
  {
    ...
    description:
      "In the Blackrose Club ecosystem, the virtual and physical worlds come together.",
